...
export declare function getMermaidFileName(mermaidContent: string | undefined): {
...
export declare class MermaidRendererPlugin implements ADFProcessingPlugin<ChartData[], Record<string, UploadedImageData | null>> {
    private mermaidRenderer;
    constructor(mermaidRenderer: MermaidRenderer);
    extract(adf: JSONDocNode): ChartData[];
    transform(mermaidNodesToUpload: ChartData[], supportFunctions: PublisherFunctions): Promise<Record<string, UploadedImageData | null>>;
