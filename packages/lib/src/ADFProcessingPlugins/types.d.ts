...
export declare function createPublisherFunctions(confluenceClient: RequiredConfluenceClient, adaptor: LoaderAdaptor, pageId: string, pageFilePath: string, currentAttachments: CurrentAttachments): PublisherFunctions;
export declare function executeADFProcessingPipeline(plugins: ADFProcessingPlugin<unknown, unknown>[], adf: JSONDocNode, supportFunctions: PublisherFunctions): Promise<JSONDocNode>;
