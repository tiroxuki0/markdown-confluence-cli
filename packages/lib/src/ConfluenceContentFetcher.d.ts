...
export declare class ConfluenceContentFetcher {
     ...
     */
    fetchPage(pageId: string, options?: FetchPageOptions): Promise<ConfluencePageData>;
    /**
     * Fetch all children of a page with pagination support
     */
    fetchChildren(parentId: string, options?: FetchChildrenOptions): Promise<ConfluencePageData[]>;
    /**
     * Fetch page tree recursively (page + all descendants)
     */
    fetchPageTree(rootPageId: string, maxDepth?: number): Promise<ConfluencePageData[]>;
    /**
     * Search for pages by title or CQL query
     * TODO: Implement when confluence.js supports searchContent
     */
    searchPages(_cql: string, _options?: FetchChildrenOptions): Promise<ConfluencePageData[]>;
    /**
     ...
     */
    getSpace(spaceKey: string): Promise<import("confluence.js/out/api/models").Space>;
    private delay;
}
