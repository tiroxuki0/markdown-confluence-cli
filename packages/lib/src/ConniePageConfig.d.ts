...
export type FrontmatterConfig<OUT, T extends InputType> = FrontmatterConfigBase<OUT> & FrontmatterConfigOptions<OUT, T>;
type ProcessFunction<IN, OUT> = (value: IN, markdownFile: MarkdownFile, alreadyParsed: Partial<ConfluencePerPageValues>, settings: ConfluenceSettings, adfContent: JSONDocNode) => OUT | Error;
...
export declare function processConniePerPageConfig(markdownFile: MarkdownFile, settings: ConfluenceSettings, adfContent: JSONDocNode): ConfluencePerPageValues;
export {};
