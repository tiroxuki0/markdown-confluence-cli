...
export declare class MarkdownFileGenerator {
     ...
     */
    generateFile(page: ConfluencePageData, markdown: string, options?: FileGenerationOptions): Promise<FileGenerationResult>;
    /**
     * Generate multiple files from array of pages
     */
    generateFiles(pages: ConfluencePageData[], markdownContents: string[], options?: FileGenerationOptions): Promise<FileGenerationResult[]>;
    /**
